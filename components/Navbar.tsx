...
export default function Navbar() {
    return(
      <>
        <div id='navbar' className='sticky top-0 w-screen rounded h-12 md:h-12 lg:h-14 bg-white overflow-hidden z-10'>
          <ul className='flex flex-row justify-center items-center space-x-6 text-black text-2xl text-center list-none h-12 md:h-12 lg:h-14'>
            ...
            <li className=''>
             ...
             <li className=''>
              <Link className='z-30 no-underline font-["Coming_Soon"] hover:text-green-400 active:text-red-400' href='#about' scroll={false}>about</Link>
            </li>
          </ul>
        </div>
        </>
